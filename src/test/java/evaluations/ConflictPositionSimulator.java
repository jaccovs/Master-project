...
public class ConflictPositionSimulator extends AbstractEvaluation {
...
//	}
	 ...
	 * @throws Exception
	 */
	private DiagnosisModel loadOrCreateModel(int kbSize, int nbConflicts, int avgConflictSize, ConflictPosition conflictPosition, int run) throws Exception {
...
//		System.out.println("Conflict size (avg should be: " + avgConflictSize + ") " + nbConflictsThisTime);
	 ...
	 * @return the list 
	 */
	public static DiagnosisModel createModel(int kbSize) {
		DiagnosisModel result = new DiagnosisModel();
