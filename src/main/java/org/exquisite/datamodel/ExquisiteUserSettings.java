...
public class ExquisiteUserSettings {
    ...
    public ExquisiteUserSettings(int colorIndexInput,
                                 int colorIndexInterim, int colorIndexoutput, EngineType diagnosisEngine,
                                 int searchDepth, int maxDiagnoses, double probabilityThreshold,
                                 ExquisiteLocaleFlag localeFlag, boolean showServerDebugMessages) {
