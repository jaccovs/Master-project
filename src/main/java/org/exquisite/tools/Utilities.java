...
public class Utilities {
	 ...
	 * @param constraints
	 */
	public static String printConstraintList(Collection<Constraint> constraints, DiagnosisModel model)  {
		String result = "[ ";
	 ...
	 * @param conflict
	 */
	public static String printConstraintList(List<Constraint> conflict, DiagnosisModel model)  {
		String result = "[ ";
	 ...
	 * @return
	 */
	public static String printConstraintListOrderedByName(Collection<Constraint> conflict, DiagnosisModel model){
	 ...
	 * @return
	 */
	static public Set<Variable> getAllVariablesOfConstraint(Constraint constraint) {
	 ...
	 */
	public static void collectStatsFromSolution(Solver solver, Map<String, Map<Integer, Integer>> statsMap, ExquisiteAppXML appXML) {
		Iterator<IntDomainVar> it = solver.getIntVarIterator();
		while (it.hasNext()) {
			IntDomainVar var = it.next();
			int value;
	 ...
	 * @return true - if reference contains ":" character implying a range.
	 ...
	 * @return
	 */
	public static List<Diagnosis> sortDiagnosesLexicographically(List<Diagnosis> diagnoses, DiagnosisModel model) {
		
		Map<String, Diagnosis> string2DiagMap = new HashMap<String, Diagnosis>();
...
//		System.out.println("Sorted my lists..: " + diagnosesAsString);
	 ...
	 * @return
	 */
	public static String printSortedDiagnoses(List<Diagnosis> diagnoses, char separator) {
		List<String> diagnosesAsString = new ArrayList<String>();
		for (Diagnosis diag : diagnoses) {
			if (diag != null)
			{
	 ...
	 * @return
	 */
	public static String printSortedConflicts(List<List<Constraint>> conflicts, DiagnosisModel model, char separator) {
		List<String> conflictsAsString = new ArrayList<String>();
		for (Collection<Constraint> conflict: conflicts) {
			if (conflict != null) {
	 ...
	 * @return
	 */
	public static List<Constraint> sortConstraintsLexicographically(Set<Constraint> constraints, DiagnosisModel model) {
