...
public abstract class AbstractTestHeuristicQC {
    ...
    public HeuristicQueryComputation<Integer> qc;
    ...
    public abstract HeuristicQueryComputation<Integer> getHeuristicQC();
    ...
    public void testGeneralConditionsForFindQPartition() {
        try {
            ...
            QPartition<Integer> qPartition = QPartitionOperations.findQPartition(diagnoses, qc.getConfig().getRm(), qc.getConfig().getDiagnosisEngine().getCostsEstimator()); //qc.findQPartition(diagnoses, qc.getPartitionRequirementsMeasure());
    ...
    public void testFindQPartition() {
        try {
            QPartition<Integer> qPartition = QPartitionOperations.findQPartition(calculateDiagnoses(), qc.getConfig().getRm(), qc.getConfig().getDiagnosisEngine().getCostsEstimator()); //qc.findQPartition(calculateDiagnoses(), qc.getPartitionRequirementsMeasure());
