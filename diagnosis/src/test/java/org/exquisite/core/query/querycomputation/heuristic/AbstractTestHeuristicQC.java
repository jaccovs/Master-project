...
public abstract class AbstractTestHeuristicQC {
    ...
    public void testGeneralConditionsForFindQPartition() {
        try {
            ...
            QPartition<Integer> qPartition = QPartitionOperations.findQPartition(diagnoses, qc.getConfig().getRm(), qc.getConfig().getDiagnosisEngine().getCostsEstimator());
    ...
    public void testFindQPartition() {
        try {
            QPartition<Integer> qPartition = QPartitionOperations.findQPartition(calculateDiagnoses(), qc.getConfig().getRm(), qc.getConfig().getDiagnosisEngine().getCostsEstimator());
