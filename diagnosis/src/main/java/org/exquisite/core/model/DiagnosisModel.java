...
public class DiagnosisModel<F> extends Observable implements Observer {
    ...
    public String toString() {
        ...
        sb.append('\n').append(possiblyFaultyFormulas.size()).append(" possiblyFaultyFormulas=").append(new ArrayList<>(possiblyFaultyFormulas));
        sb.append('\n').append(',').append(correctFormulas.size()).append(" correctFormulas=").append(new ArrayList<>(correctFormulas));
        sb.append('\n').append(',').append(entailedExamples.size()).append(" entailedExamples=").append(new ArrayList<>(entailedExamples));
        sb.append('\n').append(',').append(notEntailedExamples.size()).append(" notEntailedExamples=").append(new ArrayList<>(notEntailedExamples));
        sb.append('\n').append(',').append(consistentExamples.size()).append(" consistentExamples=").append(new ArrayList<>(consistentExamples));
        sb.append('\n').append(',').append(inconsistentExamples.size()).append(" inconsistentExamples=").append(new ArrayList<>(inconsistentExamples));
        sb.append('\n').append(", formulaWeights=").append(formulaWeights);
        sb.append('}');
        return sb.toString();
    }
}
