...
public class ObservationMatrix {
    ...
    /**
     * @param positiveCones          List of cones from positive output cells
     * @param negativeCones          List of cones from negative output cells
     * @param range                  Set of cells that should be considered in this observation
     *                               matrix
    ...
    /**
     * @param sc The coefficient that should be used
