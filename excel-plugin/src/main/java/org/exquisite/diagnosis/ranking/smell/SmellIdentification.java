...
public class SmellIdentification {
     ...
     *
     * @param xmlFilePath Filepath to the excel xml file
     ...
     *
     * @param currentPossibleCell String with a possibly cell
    ...
    private static Collection<? extends String> generateRange(int startIndex,
                                                              ...
                                                              ArrayList<String> topologicallyList,
     ...
     *
     * @param aboveAndBelowCellsResultMap First map for matching
     * @param resultMap                   Second map for matching
     */
    ...
    private static Map<String, Float> linearFunction(
        ...
        for (String cell : valueMap.keySet()) {
            ...
            if (valueMap.get(cell) < startParameter) {
                ...
                result.put(
                        cell,
                        (valueMap.get(cell) - startParameter) / (float) (endParameter - startParameter));
            }
        }
        return result;
    }
