...
public class ExquisiteAppXML {
    ...
    /**
     * @param formulasR1C1 the formulas to set
     */
    ...
    /**
     * @param pathCopy the pathCopy to set
     */
    ...
    /**
     * @param defaultValueBound the defaultValueBound to set
     */
    ...
    /**
     * @param interims the interims to set
     */
    ...
    /**
     * @param correctFormulas the correctFormulas to set
     */
    ...
    /**
     * @param value configuration settings for this debugging session.
     */
